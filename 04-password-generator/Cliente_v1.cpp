//Nota: este es el archivo sin las clases, es el basico pero que funciona bien, en este momento estoy haciendo la v2 con objetos
...
#define SERVER_ADDRESS  "192.168.0.149"     /* server IP */
#define PORT            8080 
